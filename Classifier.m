...
for SP = 1 : 10 : 450
    for Window = 50
        ...
        fprintf(['STARTING ', int2str(File),' th FILE\n'])
        parfor iipart = 1:partn.NumTestSets
            ...
            accuracyte(File,:,iipart)=accuracy_binary_classifier_all(datate,cl);
        ...
        %Temporary Accuracy
        TemporarySize=size(accuracyte);
        TA=reshape(accuracyte(File,:,:),[TemporarySize(2),TemporarySize(3)]);
        ...
        [a1,a2]=max(TA(:)); [z1,z2]=ind2sub(size(TA),a2);
